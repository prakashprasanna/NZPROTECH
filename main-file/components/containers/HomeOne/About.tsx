            ...
            <div className="col-xl-6">
              <div className="section-header mb-40">
                ...
                <p
                  ...
                  data-aos-duration="1500"
                >
Our mission is to provide intelligent business solutions that empower our clients to thrive in todays dynamic market. Through innovative thinking and cutting-edge technology, we strive to deliver tailored strategies and tools that drive success and foster growth. Partner with us to unlock the full potential of your business.
                </p>
              </div>
              <div
                className="row g-4 "
                ...
                <div className="col-md-6">
                  <div className="about__right-item">
                    ...
                    <div className="content">
                      ...
                      <p>We are one call away for any problem you face</p>
                    </div>
                  </div>
                </div>
              </div>
