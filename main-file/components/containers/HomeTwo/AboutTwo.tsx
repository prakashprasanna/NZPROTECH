          ...
          <div className="col-xl-6">
            <div className="section-header mb-40">
              ...
              <p
                ...
                data-aos-duration="1500"
              >
                At AMPRO, we are dedicated to ensuring your success by providing reliable IT solutions tailored to your unique needs, empowering your business to thrive in the ever-evolving digital landscape.
              </p>
            </div>
            <div
            ...
            >
              <ul>
                <li>
                  <i className="fa-solid fa-check"></i>Web & App Development
                </li>
                <li>
